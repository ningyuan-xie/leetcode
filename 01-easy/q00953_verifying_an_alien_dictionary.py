...
def unit_tests():
    ...
    assert Solution.isAlienSorted(["hello", "leetcode"], "hlabcdefgijkmnopqrstuvwxyz") is True

    # Input: words = ["word","world","row"], order = "worldabcefghijkmnpqstuvxyz", Output: False
    assert Solution.isAlienSorted(["word", "world", "row"], "worldabcefghijkmnpqstuvxyz") is False
    ...
    # Inputs: words = ["fxasxpc","dfbdrifhp","nwzgs","cmwqriv","ebulyfyve","miracx", "sxckdwzv","dtijzluhts","wwbmnge","qmjwymmyox"], order = "zkgwaverfimqxbnctdplsjyohu", Output: False
    assert Solution.isAlienSorted(["fxasxpc", "dfbdrifhp", "nwzgs", "cmwqriv", "ebulyfyve", "miracx", "sxckdwzv", "dtijzluhts", "wwbmnge", "qmjwymmyox"], "zkgwaverfimqxbnctdplsjyohu") is False
