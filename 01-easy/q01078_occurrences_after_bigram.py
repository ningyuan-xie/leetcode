...
def unit_tests():
    ...
    assert Solution.findOcurrences("alice is a good girl she is a good student", "a", "good") == ["girl", "student"]

    # Input: text = "we will we will rock you", first = "we", second = "will", Output: ["we","rock"]
    assert Solution.findOcurrences("we will we will rock you", "we", "will") == ["we", "rock"]
