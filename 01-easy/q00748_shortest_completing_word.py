...
def unit_tests():
    # Input: license_plate = "1s3 PSt", words = ["step", "steps", "stripe", "stepple"], Output: "steps"
    assert Solution.shortest_completing_word("1s3 PSt", ["step", "steps", "stripe", "stepple"]) == "steps"

    # Input: license_plate = "1s3 456", words = ["looks", "pest", "stew", "show"], Output: "pest"
    assert Solution.shortest_completing_word("1s3 456", ["looks", "pest", "stew", "show"]) == "pest"

    # Input: license_plate = "Ah71752", words = ["suggest", "letter", "of", "husband", "easy", "education", "drug", "prevent", "writer", "old"], Output: "husband"
    assert Solution.shortest_completing_word("Ah71752", ["suggest", "letter", "of", "husband", "easy", "education", "drug", "prevent", "writer", "old"]) == "husband"
