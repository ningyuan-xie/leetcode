...
class Solution:
    ...
    def diStringMatch(s: str) -> List[int]:
        """Optimal Solution: Greedy Algorithm and Two Pointers. Time Complexity: O(n), Space Complexity: O(n).
        The solution uses a greedy approach by always prioritizing the left pointer when the character is 'I' and the right pointer when the character is 'D'."""
        ...
        # After looping through all the chars, left = right = the remaining number
        perm.append(left)
