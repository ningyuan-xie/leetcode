<div style="background-color: black; color: white; border-radius: 8px; padding: 20px; position: relative; font-family: monospace; max-width: 600px; border: 1px solid #333;">
